...
- `.claude/skills/defold-api-fetch/SKILL.md` — updated from `apis.md`
- `.claude/skills/defold-docs-fetch/SKILL.md` — updated from `manuals.md`
- `.claude/skills/defold-examples-fetch/SKILL.md` — updated from `examples.md`
...
- `scripts/fetch_proto.py` — downloads proto schemas from the stable Defold SDK into `.claude/skills/defold-skill-maintain/assets/proto/`. Run when proto schemas are missing or need updating: `python .claude/skills/defold-skill-maintain/scripts/fetch_proto.py`
