...
Location: `.claude/skills/defold-skill-maintain/assets/proto/`
...
Key directories:
- `.claude/skills/defold-skill-maintain/assets/proto/gamesys/` — component and resource formats (`label_ddf.proto`, `physics_ddf.proto`, `atlas_ddf.proto`, `sprite_ddf.proto`, etc.)
- `.claude/skills/defold-skill-maintain/assets/proto/ddf/ddf_math.proto` — shared math types (`Vector3`, `Vector4`, `Vector4One`, `Vector4WOne`, `Point3`, `Quat`)
- `.claude/skills/defold-skill-maintain/assets/proto/ddf/ddf_extensions.proto` — proto extensions (`resource`, `displayName`)
- `.claude/skills/defold-skill-maintain/assets/proto/render/` — render and material formats
- `.claude/skills/defold-skill-maintain/assets/proto/gameobject/` — game object and properties formats
...
1. Check if `.claude/skills/defold-skill-maintain/assets/proto/` directory exists
2. If it does NOT exist, run: `python .claude/skills/defold-skill-maintain/scripts/fetch_proto.py`
3. This downloads `defoldsdk.zip` from the stable Defold release and extracts `defoldsdk/share/proto/` into `.claude/skills/defold-skill-maintain/assets/proto/`
...
2. **Ensure proto schemas exist**:
   - If `.claude/skills/defold-skill-maintain/assets/proto/` is missing, run `python .claude/skills/defold-skill-maintain/scripts/fetch_proto.py` first

3. **Find the proto schema**:
   - Search in `.claude/skills/defold-skill-maintain/assets/proto/` for the relevant `*_ddf.proto` file
