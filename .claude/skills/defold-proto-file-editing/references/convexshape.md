...
1. Get the image size using the bundled script:
   ```
   python .claude/skills/defold-proto-file-editing/scripts/get_image_size.py <image_path>
   ```
...
```
python .claude/skills/defold-proto-file-editing/scripts/gen_convexshape.py <image_path> [--output <path>] [--max-points N] [--alpha-threshold T] [--inset P]
```
...
```
python .claude/skills/defold-proto-file-editing/scripts/gen_convexshape.py assets/images/player.png -o main/player.convexshape
```

Preview to stdout first:
```
python .claude/skills/defold-proto-file-editing/scripts/gen_convexshape.py assets/images/player.png
```

Use fewer points for simpler shapes:
```
python .claude/skills/defold-proto-file-editing/scripts/gen_convexshape.py assets/images/coin.png -o main/coin.convexshape -m 8
```
